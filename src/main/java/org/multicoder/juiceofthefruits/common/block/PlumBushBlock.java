...
public class PlumBushBlock extends SweetBerryBushBlock
{
    public PlumBushBlock(String name)
    {
    ...
    protected InteractionResult useWithoutItem(BlockState p_316134_, Level p_316429_, BlockPos p_316748_, Player p_316431_, BlockHitResult p_316474_) {
        ...
        if (i > 1) {
            ...
            popResource(p_316429_, p_316748_, new ItemStack(ModItems.PLUM.get(), j + (flag ? 1 : 0)));
            p_316429_.playSound(
